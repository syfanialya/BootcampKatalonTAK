...
WebUI.click(findTestObject('Cart_already_Login/Button_Clear cart'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Cart_already_Login/Title_Your shopping cart is empty'))
