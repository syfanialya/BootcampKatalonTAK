...
switch (select_category) {
    ...
    case 'Fantasy':
        ...
        WebUI.waitForElementVisible(findTestObject('Homepage_already_Login/Fantasy_Book/Book_Harry Potter and the Half-Blood Prince'), 
            5)
    ...
    case 'Fiction':
        ...
        WebUI.waitForElementVisible(findTestObject('Homepage_already_Login/Fiction_Book/Book_Harry Potter and the Goblet of Fire'), 
            5)
    ...
    case 'Mystery':
        ...
        WebUI.waitForElementVisible(findTestObject('Homepage_already_Login/Mystery_Book/Book_Harry Potter and the Chamber of Secrets'), 
            5)
    ...
    case 'Romance':
        ...
        WebUI.waitForElementVisible(findTestObject('Homepage_already_Login/Romance_Book/Book_Harry Potter and the Prisoner of Azkaban'), 
            5)
